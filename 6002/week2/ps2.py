'''
MIT6002 edX - week 2 problem set

Last Updated: 2016-Nov-12
...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.tiles[int(pos.getY())][int(pos.getX())] = 1
...
#print(runSimulation(1, 1.0, 5, 5, 1, 100, StandardRobot), 150)
#print(runSimulation(1, 1.0, 10, 10, 0.75, 100, StandardRobot), 190)
#print(runSimulation(1, 1.0, 10, 10, 0.9, 100, StandardRobot), 310)
#print(runSimulation(1, 1.0, 20, 20, 1, 100, StandardRobot), 3322)
#print(runSimulation(3, 1.0, 20, 20, 1, 100, StandardRobot), 1105)
...
#     plot.
#
#showPlot1('Time taken to clean 80% of a 20x20 room by differing no. of robots', 'No. of robots', 'Time taken')
#
...
#     plot.
#
#showPlot2('Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms', 'Aspect ratio of room', 'Time taken')
#
